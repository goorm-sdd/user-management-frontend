        ...
        <Table className="undefined">
          ...
          <TableHeader className="border-t border-gray-100 dark:border-white/[0.05]">
            <TableRow>
              ...
              <TableCell
                isHeader
                className="px-4 py-3 border border-gray-100 dark:border-white/[0.05] text-theme-xs font-medium text-gray-700 dark:text-gray-400 text-center w-[60px]"
              >
                Edit
              </TableCell>
            </TableRow>
          ...
          <TableBody>
            {tableData.map((order) => (
              <TableRow key={order.id}>
                ...
                <TableCell className="px-4 py-3 font-normal dark:text-gray-400/90 text-gray-800 border border-gray-100 dark:border-white/[0.05] text-theme-sm whitespace-nowrap">
                  <div className="flex -space-x-2">{order.team}</div>
                </TableCell>
                <TableCell className="px-4 py-3 font-normal dark:text-gray-400/90 text-gray-800 border border-gray-100 dark:border-white/[0.05] text-theme-sm whitespace-nowrap">
                  <Badge
                    size="sm"
                ...
                <TableCell className="px-4 py-3 text-center border border-gray-100 dark:border-white/[0.05] w-[60px]">
                  <button
